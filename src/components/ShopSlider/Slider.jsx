                ...
                <div className="w-1/5" key={index}>
                  <div className="group px-2 ">
                    <div
                      ...
                      className="relative group w-[200px] h-[220px]  border-t-[3px] border-[#fff] group-hover:border-[#46A358] duration-300 transition-all "
                    >
                      <Scroll />
                      <img
                        src={item.image_url}
                      ...
                      <div className="translate-y-[50px] group-hover:translate-y-0 duration-300 transition-all flex gap-4 absolute z-10 bottom-1 left-[7%]">
                        <p
                          ...
                          className="text-[40px] cursor-pointer bg-[--bg-cart] p-1"
                        >
                          <PiShoppingCartSimpleBold
                            onClick={() => handleClick(item)}
                            className="text-[--second] hover:text-[#46A358] duration-300 bg-white p-2 rounded-xl"
                          ></PiShoppingCartSimpleBold>
                        </p>
                        <p className="text-[40px] cursor-pointer rounded-md p-1">
                          {" "}
                          <IoSearch
                            className={`text-[--second] hover:text-[#46A358] bg-white p-2 rounded-xl duration-300`}
                          ></IoSearch>
                        </p>
                        <p className="text-[40px] cursor-pointer rounded-md p-1">
                          {" "}
